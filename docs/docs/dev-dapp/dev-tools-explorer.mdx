...
<img alt="Viewblock" src={useBaseUrl('img/dev-dapp/tools/devex.png')} />
...
<img
  alt="Viewblock"
  src={useBaseUrl('img/dev-dapp/tools/devexNetworkChange.png')}
/>
...
<img alt="Viewblock" src={useBaseUrl('img/dev-dapp/tools/viewblock.png')} />
