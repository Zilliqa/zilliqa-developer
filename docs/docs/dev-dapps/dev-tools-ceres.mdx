...
![Docusaurus with Keytar](/img/dev-dapp/tools/ceres.png)
...
| MacOS                                                                                                                                                                                | Windows                                                                                                                                                                                             | Linux                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [<img alt="Download Mac" src={useBaseUrl('img/dev-dapp/tools/downloadMAC.png')} width="80" height="80"/>](https://github.com/Zilliqa/ceres/releases/download/v0.2.5/Ceres-0.2.5.dmg) | [<img alt="Download Windows" src={useBaseUrl('img/dev-dapp/tools/downloadWindows.png')} width="80" height="80" />](https://github.com/Zilliqa/ceres/releases/download/v0.2.5/Ceres.Setup.0.2.5.exe) | [<img alt="Download Linux" src={useBaseUrl('img/dev-dapp/tools/downloadLinux.png')} width="80" height="80" />](https://github.com/Zilliqa/ceres/releases/download/v0.2.5/Ceres-0.2.5.AppImage) |
...
<img
  alt="Isolated Server"
  src={useBaseUrl('img/dev-dapp/tools/isolatedStartService.png')}
/>
...
<img
  alt="Devex"
  src={useBaseUrl('img/dev-dapp/tools/explorerStartService.png')}
/>
...
<img
  alt="Scilla Server"
  src={useBaseUrl('img/dev-dapp/tools/scillaStartService.png')}
/>
...
<img
  ...
  src={useBaseUrl('img/dev-dapp/tools/customNetworkDetails.png')}
/>
...
<img
  alt="Faucet Request"
  src={useBaseUrl('img/dev-dapp/tools/faucetRequest.png')}
/>
...
<img
  alt="Deploy Contract"
  src={useBaseUrl('img/dev-dapp/tools/deployContract.png')}
/>

<img
  alt="Deploy Success"
  src={useBaseUrl('img/dev-dapp/tools/deploySuccess.png')}
/>
...
<img alt="Devex" src={useBaseUrl('img/dev-dapp/tools/deployDevex.png')} />
