...
> **Note**: Chainlink Community Deployment price feeds are not official integrations. [Learn More](https://docs.chain.link/data-feeds/selecting-data-feeds/#chainlink-community-deployments) > **Note**: Developers should understand risks associated with community deployments. [Learn More](https://docs.chain.link/data-feeds/selecting-data-feeds/#chainlink-community-deployments)
