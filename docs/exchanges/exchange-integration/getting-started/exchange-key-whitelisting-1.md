...
$ curl -O[https://mainnet-join.zilliqa.com/seed-configuration.tar.gz](https://mainnet-join.zilliqa.com/seed-configuration.tar.gz)$ tar -zxvf seed-configuration.tar.gz
