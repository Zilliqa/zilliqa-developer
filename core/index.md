...
- [Schnorr Algorithm](schnorr-algorithm.md)
...
- [Protobuf and Serialization](protobuf-and-serialization.md)
- [Message Dispatch and Processing](message-dispatch-and-processing.md)
...
- [Operational Details (State Machine)](ds-operational-details.md)
- [DS MIMO](ds-mimo.md)
- [DS Reputation](ds-reputation.md)

## Shard Node

- [Operational Details (State Machine)](shard-operational-details.md)
