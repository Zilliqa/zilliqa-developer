...
![image01](images/features/consensus/image01.jpg)
...
To address this situation, we changed the consensus implementation to support two concurrently running consensuses across different subsets of peers. This is how it works:
