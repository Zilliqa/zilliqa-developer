...
async function setupBalancesOnAccounts(accounts) {
  let nftSellerBalance = await getBalance(accounts.nftSeller.address);
  ...
  let nftBuyerBalance = await getBalance(accounts.nftBuyer.address);
  ...
  let strangerBalance = await getBalance(accounts.stranger.address);
  ...
  let forbiddenBalance = await getBalance(accounts.forbidden.address);
...
async function clearBalancesOnAccounts(accounts) {
  let contractOwner = await getBalance(accounts.contractOwner.address);
