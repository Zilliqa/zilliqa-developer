...
import StarSvg from "./components/cards_img01";
import CodeSvg from "./components/cards_img02";
import MineSvg from "./components/cards_img03";
import ExchangeSvg from "./components/cards_img04";
import ContributeSvg from "./components/cards_img05";
...
const CoverImgDiv = () => {
  ...
  if (isDarkTheme) {
    ...
    return (
      <div className="cover-image">
        <img
          className="cover-image-hand"
          src={useBaseUrl("img/hand_light.png")}
        />
      </div>
    );
  }
