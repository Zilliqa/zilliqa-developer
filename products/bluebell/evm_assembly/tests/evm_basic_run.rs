...
mod tests {
    ...
    fn blah() {
        ...
        let mut builder = EvmByteCodeBuilder::from_bytes(&mut specification, bytes);

        // TODO:
        // builder.define_function("blah", ["Int32", "Int32"].to_vec(), "Int32")
        //     .build()

        builder
            .define_function("fibonacci", ["Uint256"].to_vec(), "Uint256")
            .build(|| {
                println!("Builder invoked.");
                0
            });
