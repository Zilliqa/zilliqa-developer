...
const ImportExport: React.FC<IProps> = ({
  type,
  map,
  setMapCb,
  toJson,
      ...
      <div className="import-export">
        <span className="mr-1" {...getRootProps()}>
          ...
          <OverlayTrigger
            placement="top"
            overlay={
              <Tooltip id={"import-tt"}>
                {type === "labels" ? "Import Labels" : "Import Networks"}
              </Tooltip>
            }
          >
            <Button>
        ...
        <span className="ml-2">
          <OverlayTrigger
            placement="top"
            overlay={
              <Tooltip id={"export-tt"}>
                {type === "labels" ? "Export Labels" : "Export Networks"}
              </Tooltip>
            }
          >
            <Button
