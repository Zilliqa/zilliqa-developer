    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ row }: { row: Row<TransactionDetails> }) => {
          console.log(row);
          return (
            <QueryPreservingLink to={`/tx/0x${row.original.hash}`}>
      ...
      {error ? (
        ...
        <>
          {latestTxBlockNum && (
            <div
              className={
                isIsolatedServer ? "txblock-header mb-3" : "txblock-header"
              }
            >
              <h3 className="mb-1">
                <span className="mr-1">
                ...
                <span className="ml-2">Tx Block</span>{" "}
              ...
              <span>
                ...
                <QueryPreservingLink
                  className={
                    isIsolatedServer
                      ? parseInt(blockNum, 10) === latestTxBlockNum
                        ? "disabled"
                        : ""
                      : parseInt(blockNum, 10) === latestTxBlockNum - 1
                      ? "disabled"
                      : ""
                  }
                  to={`/txbk/${parseInt(blockNum, 10) + 1}`}
                    ...
                    <BRow>
                      <BCol>
                        <div className="txblock-detail">
                          ...
                          <span>
                            <QueryPreservingLink
                              to={`/dsbk/${txBlockObj.header.DSBlockNum}`}
                            >
                      ...
                      <BCol>
                        <div className="txblock-detail">
                          ...
                          <span>
                            <QueryPreservingLink
                              to={`/address/${pubKeyToZilAddr(
                                txBlockObj.header.MinerPubKey
                              )}`}
                            >
