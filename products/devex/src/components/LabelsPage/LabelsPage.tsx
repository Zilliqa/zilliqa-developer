        ...
        <Row className="justify-content-between flex-nowrap m-0">
          <div className="filter-div">
            ...
            <Dropdown className="ml-3">
              ...
              <Dropdown.Menu>
                <Dropdown.Item onClick={() => setNetworkNameFilter("All")}>
                  All
                </Dropdown.Item>
                {[
                  ...new Set(
                  ...
                  <Dropdown.Item
                    onClick={() => setNetworkNameFilter(labelName)}
                    key={index}
                  >
                    {labelName}
                  </Dropdown.Item>
            ...
            <span className="ml-3">Label Type:</span>
            <Dropdown className="ml-3">
              <Dropdown.Toggle id="label-type-toggle">
                {typefilter}
              </Dropdown.Toggle>
              <Dropdown.Menu>
                ...
                <Dropdown.Item onClick={() => setTypefilter("Account")}>
                  Accounts
                </Dropdown.Item>
                <Dropdown.Item onClick={() => setTypefilter("Contract")}>
                  Contracts
                </Dropdown.Item>
                <Dropdown.Item onClick={() => setTypefilter("Transaction")}>
                  Transactions
                </Dropdown.Item>
                <Dropdown.Item onClick={() => setTypefilter("Tx Block")}>
                  Tx Blocks
                </Dropdown.Item>
                <Dropdown.Item onClick={() => setTypefilter("DS Block")}>
                  DS Blocks
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          ...
          <ImportExport type="labels" map={labelMap} setMapCb={setLabelMap} />
        </Row>
        <Row className="mt-3">
          {Object.entries(labelMap).length === 0 ? (
            <Dropzone fromJson={(x: any) => x} dropCb={setLabelMap} />
          ) : (
