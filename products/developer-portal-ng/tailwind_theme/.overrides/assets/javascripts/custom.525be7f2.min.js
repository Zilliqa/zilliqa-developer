...
(() => {
  ...
  var it = (e, r, t) =>
      r in e
        ...
        : (e[r] = t),
    Qe = (e, r) => {
      for (var t in r || (r = {})) at.call(r, t) && it(e, t, r[t]);
      if (ot) for (var t of ot(r)) no.call(r, t) && it(e, t, r[t]);
      return e;
    };
  var ve = (e, r) => () => (
    ...
    if ((r && typeof r == "object") || typeof r == "function")
      for (let o of ro(r))
        !at.call(e, o) &&
          ...
          Fr(e, o, {
            get: () => r[o],
            enumerable: !(n = eo(r, o)) || n.enumerable,
          });
    return e;
  };
  var kr = (e, r, t) => (
    ...
    oo(
      r || !e || !e.__esModule
        ? Fr(t, "default", { value: e, enumerable: !0 })
        : t,
      e
    )
  );
...
***************************************************************************** */ var st,
    ...
    (function (e) {
      ...
      typeof define == "function" && define.amd
        ...
        : typeof Je == "object" && typeof Je.exports == "object"
        ? e(t(r, t(Je.exports)))
        : e(t(r));
      function t(n, o) {
        return (
      ...
      (st = function (n, o) {
        ...
        (ft = function (n, o) {
          ...
          if (n != null && typeof Object.getOwnPropertySymbols == "function")
            for (
              var u = 0, a = Object.getOwnPropertySymbols(n);
              u < a.length;
              u++
            )
              o.indexOf(a[u]) < 0 &&
                Object.prototype.propertyIsEnumerable.call(n, a[u]) &&
                (i[a[u]] = n[a[u]]);
          return i;
        }),
        (ct = function (n, o, i, a) {
          ...
          if (
            ...
            for (var c = n.length - 1; c >= 0; c--)
              (f = n[c]) &&
                (s = (u < 3 ? f(s) : u > 3 ? f(o, i, s) : f(o, i)) || s);
          return u > 3 && s && Object.defineProperty(o, i, s), s;
        }),
        (lt = function (n, o) {
          return function (i, a) {
            o(i, a, n);
        ...
        (mt = function (n, o, i, a) {
          ...
          return new (i || (i = Promise))(function (s, f) {
            ...
            function l(h) {
              h.done ? s(h.value) : u(h.value).then(c, p);
            }
        ...
        (ht = function (n, o) {
          var i = {
            ...
            f;
          return (
            (f = { next: c(0), throw: c(1), return: c(2) }),
                  ...
                  u &&
                    (s =
                      l[0] & 2
                        ? u.return
                        : l[0]
                        ? u.throw || ((s = u.return) && s.call(u), 0)
                        : u.next) &&
                    !(s = s.call(u, l[1])).done)
                )
                  return s;
                switch (((u = 0), s && (l = [l[0] & 2, s.value]), l[0])) {
                  case 0:
                  case 1:
                    s = l;
                    break;
        ...
        (Hr = function (n, o) {
          ...
          var a = i.call(n),
            ...
            f;
          try {
            for (; (o === void 0 || o-- > 0) && !(u = a.next()).done; )
              s.push(u.value);
          } catch (c) {
            f = { error: c };
          } finally {
        ...
        (vt = function () {
          for (var n = [], o = 0; o < arguments.length; o++)
            n = n.concat(Hr(arguments[o]));
          return n;
        }),
        (bt = function () {
          for (var n = 0, o = 0, i = arguments.length; o < i; o++)
            n += arguments[o].length;
          for (var a = Array(n), u = 0, o = 0; o < i; o++)
            for (var s = arguments[o], f = 0, c = s.length; f < c; f++, u++)
              a[u] = s[f];
          return a;
        }),
        (yt = function (n, o, i) {
          if (i || arguments.length === 2)
            for (var a = 0, u = o.length, s; a < u; a++)
              (s || !(a in o)) &&
                (s || (s = Array.prototype.slice.call(o, 0, a)), (s[a] = o[a]));
          return n.concat(s || Array.prototype.slice.call(o));
        }),
        (Oe = function (n) {
          return this instanceof Oe ? ((this.v = n), this) : new Oe(n);
        }),
        (xt = function (n, o, i) {
          ...
          function p(m) {
            m.value instanceof Oe
              ? Promise.resolve(m.value.v).then(l, h)
              : d(s[0][2], m);
          }
          function l(m) {
            c("next", m);
          ...
          function d(m, b) {
            m(b), s.shift(), s.length && c(s[0][0], s[0][1]);
          }
        }),
        (gt = function (n) {
          var o, i;
        ...
        (wt = function (n) {
          ...
          return o
            ? o.call(n)
            : ((n = typeof Ke == "function" ? Ke(n) : n[Symbol.iterator]()),
              (i = {}),
              a("next"),
              a("throw"),
              a("return"),
      ...
      (St = function (n) {
        ...
        (Tt = function (n, o, i, a, u) {
          ...
          return a === "a" ? u.call(n, i) : u ? (u.value = i) : o.set(n, i), i;
        }),
        e("__extends", st),
        e("__assign", ut),
        e("__rest", ft),
        ...
        e("__spreadArray", yt),
        e("__await", Oe),
        e("__asyncGenerator", xt),
        e("__asyncDelegator", gt),
        e("__asyncValues", wt),
        e("__makeTemplateObject", _t),
        e("__importStar", St),
        e("__importDefault", Et),
        e("__classPrivateFieldGet", Ot),
        e("__classPrivateFieldSet", Tt);
    });
  });
  var $e = ve((Y) => {
    (function () {
      var e, r, t, n, o, i, a, u, s, f, c, p, l, h, d, m, b, w, S, R;
      (R = 150),
        (f = 20),
        (S = 150),
        (s = 0.75),
        (Y.score = function (v, y, _) {
          var O, x, g, T;
          return (
            (x = _.preparedQuery),
            (O = _.allowErrors),
            O || o(v, x.core_lw, x.core_up)
              ? ((T = v.toLowerCase()), (g = r(v, T, x)), Math.ceil(g))
              : 0
          );
        }),
        (Y.isMatch = o =
          function (v, y, _) {
            var O, x, g, T, P, z, C;
            if (((g = v.length), (T = y.length), !g || T > g)) return !1;
            for (O = -1, x = -1; ++x < T; ) {
              for (
                P = y.charCodeAt(x), z = _.charCodeAt(x);
                ++O < g && ((C = v.charCodeAt(O)), !(C === P || C === z));
        ...
        (Y.computeScore = r =
          function (v, y, _) {
            ...
            if (
              ...
              return h(D, q, x, O.pos);
            if (((se = y.indexOf(oe)), se > -1))
              return d(v, y, me, oe, se, D, q);
            for (
              Ee = new Array(D),
                P = new Array(D),
                Pr = w(D, q),
              ...
              (Ee[I] = 0), (P[I] = 0);
            for (H = -1; ++H < q; ) {
              if (((Lr = y[H]), !Lr.charCodeAt(0) in _.charCodes)) {
                if (C) {
                  for (I = -1; ++I < D; ) P[I] = 0;
                  C = !1;
                }
              ...
              for (ue = 0, Cr = 0, T = 0, de = !0, C = !0, I = -1; ++I < D; ) {
                if (((Ge = Ee[I]), Ge > ue && (ue = Ge), (z = 0), oe[I] === Lr))
                  if (
                    ((Rr = u(H, v, y)),
                    (z = T > 0 ? T : l(v, y, me, oe, H, I, Rr)),
                    (g = Cr + p(H, I, Rr, x, z)),
                    g > ue)
                  )
                    (ue = g), (ne = j);
                  else {
                    if (de && --ne <= 0) return Math.max(ue, Ee[D - 1]) * Pr;
                    de = !1;
                  }
                (Cr = Ge), (T = P[I]), (P[I] = z), (Ee[I] = ue);
              }
            }
            return (ue = Ee[D - 1]), ue * Pr;
          }),
        (Y.isWordStart = u =
          function (v, y, _) {
            var O, x;
        ...
        (Y.scoreCharacter = p =
          function (v, y, _, O, x) {
            var g;
            return (g = b(v)), _ ? g + R * ((O > x ? O : x) + 10) : g + R * x;
          }),
        (Y.scoreConsecutives = l =
          function (v, y, _, O, x, g, T) {
            var P, z, C, H, I, q, j;
            for (
              z = v.length,
                H = _.length,
              ...
              _[g] === v[x] && q++;
            return (
              j < P && x--, j === 1 ? 1 + 2 * q : m(j, H, q, T, a(x, v, y, z))
            );
          }),
        (Y.scoreExactMatch = d =
          function (v, y, _, O, x, g, T) {
            ...
            for (
              ...
              _[x + z] === v[z] && H++;
            return (P = a(x + g - 1, v, y, T)), h(g, T, m(g, g, H, I, P), x);
          }),
        (e = (function () {
          function v(y, _, O) {
            (this.score = y), (this.pos = _), (this.count = O);
          }
          return v;
        })()),
        (t = new e(0, 0.1, 0)),
        (Y.scoreAcronyms = c =
          function (v, y, _, O) {
            var x, g, T, P, z, C, H, I, q, j, ne;
            if (((z = v.length), (C = _.length), !(z > 1 && C > 1))) return t;
            for (x = 0, j = 0, ne = 0, I = 0, T = -1, P = -1; ++P < C; ) {
              if (((H = O[P]), i(H)))
                if (((T = y.indexOf(H, T + 1)), T > -1)) {
                  j++;
                  continue;
                } else break;
              for (; ++T < z; )
        ...
        (n = function (v, y, _, O) {
          var x, g, T, P;
          if (((T = v.length), (P = _.length), (x = 0), T > 12 * P)) return !1;
          for (g = -1; ++g < T; ) if (u(g, v, y) && ++x > O) return !1;
          return !0;
        });
    }.call(Y));
  });
  var Mr = ve((Ne) => {
    (function () {
      ...
      (f = $e()),
        ...
        (s = 20),
        (t = 2.5),
        (Ne.score = function (c, p, l) {
          var h, d, m, b;
          return (
            (d = l.preparedQuery),
            (h = l.allowErrors),
            h || i(c, d.core_lw, d.core_up)
              ? ((b = c.toLowerCase()),
                (m = e(c, b, d)),
                (m = a(c, b, m, l)),
                Math.ceil(m))
        ...
        (a = function (c, p, l, h) {
          var d, m, b, w, S, R, v, y, _, O;
          if (l === 0) return 0;
          for (
            _ = h.preparedQuery,
              O = h.useExtensionBonus,
              y = h.pathSeparator,
              S = c.length - 1;
            c[S] === y;
          ...
          if (
            ...
            (v = S - b),
            (R = 1),
            O && ((R += o(p, _.ext, b, S, 2)), (l *= R)),
            b === -1)
          )
            return l;
          for (w = _.depth; b > -1 && w-- > 0; ) b = c.lastIndexOf(y, b - 1);
          return (
            (m =
              b === -1
                ? l
                : R * e(c.slice(b + 1, S + 1), p.slice(b + 1, S + 1), _)),
            (d = (0.5 * s) / (s + r(c, S + 1, y))),
            d * m + (1 - d) * l * u(0, t * v)
          );
        }),
        ...
        (o = function (c, p, l, h, d) {
          var m, b, w, S;
          if (!p.length || ((S = c.lastIndexOf(".", h)), !(S > l))) return 0;
          for (
            w = p.length,
              m = h - S,
              m < w && ((w = m), (m = p.length)),
          ...
          return b === 0 && d > 0 ? 0.9 * o(c, p, l, S - 2, d - 1) : b / m;
        });
    }.call(Ne));
  });
  var rt = ve((Hn, Wn) => {
    (function () {
      ...
      (u = Mr()),
        ...
        (i = /[ _\-:\/\\]/g),
        (r = function (s, f) {
          return f == null && (f = i), s.replace(f, "");
        }),
        (a = function (s) {
          var f, c, p, l;
          for (c = "", p = 0, l = s.length; p < l; p++)
            (f = s[p]), (c += f.toUpperCase()[0]);
          return c;
        }),
        (n = function (s) {
          var f, c, p;
          for (p = s.length, c = -1, f = []; ++c < p; ) f[s.charCodeAt(c)] = !0;
          return f;
        });
    }.call(Hn));
  });
  var jn = ve((zn, Un) => {
    (function () {
      ...
      (n = $e()),
        ...
        (Un.exports = function (i, a, u) {
          var s, f, c, p, l, h, d, m, b, w, S, R, v;
          for (
            m = [],
              c = u.key,
              l = u.maxResults,
            ...
            !(
              !!w &&
              ((h = d.score(w, a, u)),
              h > 0 && (m.push({ candidate: f, score: h }), !--b))
            ));
            R++
          );
      ...
      (f = $e()),
        ...
        (Ir.match = o =
          function (c, p, l) {
            ...
            return (
              ...
              (w = l.preparedQuery),
              (b = l.pathSeparator),
              h || t(c, w.core_lw, w.core_up)
                ? ((S = c.toLowerCase()),
                  (m = r(c, S, w)),
                  m.length === 0 ||
                    (c.indexOf(b) > -1 && ((d = e(c, S, w, b)), (m = i(m, d)))),
                  m)
                : []
            );
          }),
        (Ir.wrap = function (c, p, l) {
          var h, d, m, b, w, S, R, v, y;
          if (
            (l.wrap != null &&
              ((y = l.wrap),
              (S = y.tagClass),
          ...
          for (b = "", h = -1, w = 0; ++h < m.length; ) {
            for (
              d = m[h], d > w && ((b += c.substring(w, d)), (w = d));
              ++h < m.length;
            ...
            d++,
              d > w && ((b += v), (b += c.substring(w, d)), (b += R), (w = d));
          }
          return w <= c.length - 1 && (b += c.substring(w)), b;
        }),
        (e = function (c, p, l, h) {
          var d, m, b;
          for (b = c.length - 1; c[b] === h; ) b--;
          if (((d = c.lastIndexOf(h, b)), d === -1)) return [];
          for (m = l.depth; m-- > 0; )
            if (((d = c.lastIndexOf(h, d - 1)), d === -1)) return [];
          return d++, b++, r(c.slice(d, b), p.slice(d, b), l, d);
        }),
        (i = function (c, p) {
          var l, h, d, m, b, w, S;
          if (((b = c.length), (w = p.length), w === 0)) return c.slice();
          if (b === 0) return p.slice();
          for (d = -1, m = 0, h = p[m], S = []; ++d < b; ) {
            for (l = c[d]; h <= l && ++m < w; ) h < l && S.push(h), (h = p[m]);
            S.push(l);
          }
          for (; m < w; ) S.push(p[m++]);
          return S;
        ...
        (r = function (c, p, l, h) {
          ...
          for (
            ...
            (D[g] = 0), (_[g] = 0);
          for (x = -1; ++x < T; )
            for (j = 0, se = 0, y = 0, me = p[x], g = -1; ++g < C; )
              (O = 0),
                (R = 0),
                (ne = se),
                q[g] === me &&
                  ((oe = n(x, c, p)),
                  (O = y > 0 ? y : s(c, p, I, q, x, g, oe)),
                  (R = ne + u(x, g, oe, S, O))),
                (se = D[g]),
                (y = _[g]),
                j > se ? (z = m) : ((j = se), (z = w)),
      ...
      (t = jn()),
        ...
        (r =
          (typeof process != "undefined" && process !== null
            ...
            : "/"),
        (Dn.exports = {
          filter: function (s, f, c) {
            return (
              c == null && (c = {}),
              (f != null ? f.length : void 0) && (s != null ? s.length : void 0)
                ? ((c = o(c, f)), t(s, f, c))
                : []
            );
          },
          score: function (s, f, c) {
            return (
              c == null && (c = {}),
              (s != null ? s.length : void 0) && (f != null ? f.length : void 0)
                ? ((c = o(c, f)),
                  c.usePathScoring ? i.score(s, f, c) : u.score(s, f, c))
                : 0
            );
          },
          match: function (s, f, c) {
            var p, l, h;
            return (
              c == null && (c = {}),
              s
          ...
          wrap: function (s, f, c) {
            return (
              c == null && (c = {}),
              s ? (f ? ((c = o(c, f)), n.wrap(s, f, c)) : []) : []
            );
          },
          prepareQuery: function (s, f) {
            return f == null && (f = {}), (f = o(f, s)), f.preparedQuery;
          },
        }),
        (o = function (s, f) {
          return (
            s.allowErrors == null && (s.allowErrors = !1),
            s.usePathScoring == null && (s.usePathScoring = !0),
            s.useExtensionBonus == null && (s.useExtensionBonus = !1),
            s.pathSeparator == null && (s.pathSeparator = r),
            s.optCharRegEx == null && (s.optCharRegEx = null),
            s.wrap == null && (s.wrap = null),
            s.preparedQuery == null &&
              (s.preparedQuery = a && a.query === f ? a : (a = new e(f, s))),
            s
          );
        });
    }.call(qn));
  ...
  var Mt = kr(At(), 1),
    {
      ...
      __asyncDelegator: yi,
      __asyncValues: Lt,
      __makeTemplateObject: xi,
      __importStar: gi,
      __importDefault: wi,
      __classPrivateFieldGet: _i,
      __classPrivateFieldSet: Si,
    } = Mt.default;
  function E(e) {
...
` +
        ...
        if (!this.closed) {
          ...
          if (a)
            if (((this._parentage = null), Array.isArray(a)))
              try {
                for (var u = re(a), s = u.next(); !s.done; s = u.next()) {
                  var f = s.value;
                  f.remove(this);
                }
              } catch (m) {
          ...
          if (E(c))
            try {
              ...
              i = m instanceof er ? m.errors : [m];
            }
          var p = this._finalizers;
          if (p) {
            this._finalizers = null;
            try {
              for (var l = re(p), h = l.next(); !h.done; h = l.next()) {
                var d = h.value;
                try {
                  Rt(d);
                } catch (m) {
  ...
  var Te = {
    setTimeout: function (e, r) {
      ...
      return o != null && o.setTimeout
        ? o.setTimeout.apply(o, U([e, r], W(t)))
        : setTimeout.apply(void 0, U([e, r], W(t)));
    },
  ...
  var We = (function (e) {
    ...
    function r(t) {
      ...
      return (
        (n.isStopped = !1),
        t ? ((n.destination = t), rr(t) && t.add(n)) : (n.destination = uo),
        n
      );
    }
    return (
      ...
      (r.prototype.next = function (t) {
        this.isStopped ? jr(kt(t), this) : this._next(t);
      }),
  ...
  var io = Function.prototype.bind;
  function Ur(e, r) {
    return io.call(e, r);
  }
  var ao = (function () {
        ...
        if (E(t) || !t)
          ...
          i && te.useDeprecatedNextContext
            ? ((u = Object.create(t)),
              ...
              (a = {
                next: t.next && Ur(t.next, u),
                error: t.error && Ur(t.error, u),
                complete: t.complete && Ur(t.complete, u),
              }))
            : (a = t);
        }
        return (i.destination = new ao(a)), i;
      }
      return r;
    })(We);
  function nr(e) {
    te.useDeprecatedSynchronousErrorHandling ? Ht(e) : tr(e);
  }
  function so(e) {
    throw e;
  }
  ...
  var uo = { closed: !0, next: ce, error: so, complete: ce };
  var Me = (function () {
  ...
  function zt(e) {
    var r;
    return (r = e != null ? e : te.Promise) !== null && r !== void 0
      ? r
      : Promise;
  }
  function fo(e) {
  ...
  function co(e) {
    return (e && e instanceof We) || (fo(e) && rr(e));
  }
  function lo(e) {
  ...
  function M(e, r, t, n, o) {
    return new po(e, r, t, n, o);
  }
  var po = (function (e) {
    V(r, e);
    function r(t, n, o, i, a, u) {
      ...
      (r.prototype.next = function (t) {
        ...
        Ae(function () {
          ...
          if ((n._throwIfClosed(), !n.isStopped)) {
            ...
            try {
              for (
                var a = re(n.currentObservers), u = a.next();
                !u.done;
                u = a.next()
              ) {
                var s = u.value;
      ...
      (r.prototype._innerSubscribe = function (t) {
        ...
        return i || a
          ...
          : ((this.currentObservers = null),
            u.push(t),
            new ie(function () {
              (n.currentObservers = null), fe(u, t);
            }));
      }),
    ...
    return (
      ...
      (r.prototype._trimBuffer = function () {
        var t = this,
          ...
          u = (a ? 1 : 2) * n;
        if ((n < 1 / 0 && u < i.length && i.splice(0, i.length - u), !a)) {
          for (var s = o.now(), f = 0, c = 1; c < i.length && i[c] <= s; c += 2)
            f = c;
          f && i.splice(0, f + 1);
        }
      }),
  ...
  var Ue = {
    setInterval: function (e, r) {
      ...
      return o != null && o.setInterval
        ? o.setInterval.apply(o, U([e, r], W(t)))
        : setInterval.apply(void 0, U([e, r], W(t)));
    },
  ...
  var or = (function (e) {
    ...
    return (
      ...
      (r.prototype.requestAsyncId = function (t, n, o) {
        return (
          o === void 0 && (o = 0), Ue.setInterval(t.flush.bind(t, this), o)
        );
      }),
  ...
  function Ce(e) {
    return E(Dr(e)) ? e.pop() : void 0;
  }
  function ae(e) {
    return ar(Dr(e)) ? e.pop() : void 0;
  }
  function Gt(e, r) {
    return typeof Dr(e) == "number" ? e.pop() : r;
  }
  var Le = function (e) {
  ...
  function fr(e) {
    return (
      Symbol.asyncIterator && E(e == null ? void 0 : e[Symbol.asyncIterator])
    );
  }
  function cr(e) {
  ...
  function ho(e) {
    return new L(function (r) {
      var t = e[Me]();
      if (E(t.subscribe)) return t.subscribe(r);
      throw new TypeError(
  ...
  function go(e, r) {
    ...
    return It(this, void 0, void 0, function () {
      ...
      return Be(this, function (s) {
        switch (s.label) {
          case 0:
            s.trys.push([0, 5, 6, 11]), (t = Lt(e)), (s.label = 1);
          case 1:
            return [4, t.next()];
          case 2:
  ...
  function Zt(e, r) {
    if (e != null) {
      if (ur(e)) return Kt(e, r);
      if (Le(e)) return Jt(e, r);
      if (sr(e)) return Yt(e, r);
      if (fr(e)) return br(e, r);
      if (pr(e)) return Bt(e, r);
      if (hr(e)) return Xt(e, r);
    }
    throw cr(e);
  }
  function B(e, r) {
  ...
  function _o(e, r) {
    return wo(r) ? e.apply(void 0, U([], W(r))) : e(r);
  }
  function yr(e) {
    return k(function (r) {
      return _o(e, r);
  ...
  function rn(e) {
    if (e.length === 1) {
      var r = e[0];
      if (So(r)) return { args: r, keys: null };
      if (Ao(r)) {
        var t = To(r);
        return {
  ...
  function Ao(e) {
    return e && typeof e == "object" && Eo(e) === Oo;
  }
  function tn(e, r) {
  ...
  function on(e, r, t, n, o, i, a, u) {
    var s = [],
      f = 0,
      c = 0,
      p = !1,
      l = function () {
        p && !s.length && !f && r.complete();
      },
      h = function (m) {
        return f < n ? d(m) : s.push(m);
      },
      d = function (m) {
        i && r.next(m), f++;
        var b = !1;
  ...
  var Io = ["addListener", "removeListener"],
    Co = ["addEventListener", "removeEventListener"],
    Lo = ["on", "off"];
  function Q(e, r, t, n) {
    if ((E(t) && ((n = t), (t = void 0)), n)) return Q(e, r, t).pipe(yr(n));
    var o = W(
        Fo(e)
          ? Co.map(function (u) {
              return function (s) {
  ...
  function gr(e, r, t) {
    e === void 0 && (e = 0), t === void 0 && (t = Dt);
    var n = -1;
    return (
      r != null && (ar(r) ? (t = r) : (n = r)),
      new L(function (o) {
        var i = en(e) ? +e - t.now() : e;
        i < 0 && (i = 0);
        var a = 0;
  ...
  function $() {
    ...
    var t = ae(e),
      n = Gt(e, 1 / 0),
      o = e;
    return o.length ? (o.length === 1 ? F(o[0]) : xr(n)(B(o, t))) : le;
  }
  var qe = new L(ce);
  var ko = Array.isArray;
  function un(e) {
    return e.length === 1 && ko(e[0]) ? e[0] : e;
  }
  function we(e, r) {
    return A(function (t, n) {
      var o = 0;
                  ...
                  M(
                    ...
                    function (c) {
                      if (
                        ...
                        o.next(t ? t.apply(void 0, U([], W(p))) : p),
                          i.some(function (l, h) {
                            return !l.length && a[h];
                          }) && o.complete();
                      }
    ...
    return A(function (r, t) {
      ...
      r.subscribe(
        M(
          t,
          function (f) {
            (n = !0), (o = f), i || F(e(f)).subscribe((i = M(t, u, s)));
          },
          function () {
        ...
        t.subscribe(
          M(
            ...
            function (a) {
              ...
              i++ % r === 0 && o.push([]);
              try {
                for (var l = re(o), h = l.next(); !h.done; h = l.next()) {
                  var d = h.value;
                  d.push(a),
              ...
              if (p)
                try {
                  for (var m = re(p), b = m.next(); !b.done; b = m.next()) {
                    var d = b.value;
                    fe(o, d), n.next(d);
                  }
                } catch (w) {
            ...
            function () {
              var a, u;
              try {
                for (var s = re(o), f = s.next(); !f.done; f = s.next()) {
                  var c = f.value;
                  n.next(c);
                }
              } catch (p) {
      ...
      A(function (t, n) {
        ...
        function s() {
          var f = a + e,
            c = r.now();
          if (c < f) {
            (o = this.schedule(void 0, f - c)), n.add(o);
            return;
          }
          u();
        }
        t.subscribe(
          M(
            n,
            function (f) {
              (i = f), (a = r.now()), o || ((o = r.schedule(s, e)), n.add(o));
            },
            function () {
              u(), n.complete();
            },
  ...
  function Yr(e, r) {
    return r
      ? function (t) {
          return je(r.pipe(Kr(1), ln()), t.pipe(Yr(e)));
        }
      : ge(function (t, n) {
          return e(t, n).pipe(Kr(1), pn(t));
        });
  }
  function Jr(e, r) {
    r === void 0 && (r = xe);
        ...
        v.add(function () {
          ...
          !c &&
            ...
            ((c = new ye({
              ...
              error: function (_) {
                (m = !0), b(), (p = Br(w, o, _)), y.error(_);
              },
              complete: function () {
                (d = !0), b(), (p = Br(w, a)), y.complete();
              },
            })),
            F(R).subscribe(c));
      })(f);
  ...
  function Br(e, r) {
    ...
    if (r !== !1) {
      ...
      return r.apply(void 0, U([], W(t))).subscribe(o);
    }
  }
  function Se(e, r, t) {
    var n,
  ...
  function Pe(e, r, t) {
    var n = E(e) || r || t ? { next: e, error: r, complete: t } : e;
    return n
      ? A(function (o, i) {
          var a;
          ...
          o.subscribe(
            M(
              ...
              function () {
                var s, f;
                u &&
                  ((s = n.unsubscribe) === null || s === void 0 || s.call(n)),
  ...
  function hn() {
    for (var e = [], r = 0; r < arguments.length; r++) e[r] = arguments[r];
    return A(function (t, n) {
      fn.apply(void 0, U([t], W(e))).subscribe(n);
    });
  }
  function Xr() {
    for (var e = [], r = 0; r < arguments.length; r++) e[r] = arguments[r];
    return hn.apply(void 0, U([], W(e)));
  }
  ...
  function bn(e) {
    return $(Q(document.body, "focusin"), Q(document.body, "focusout")).pipe(
      Qr(1),
      k(() => {
        let r = Sr();
  ...
  function xn(e) {
    return $(Q(e, "scroll"), Q(window, "resize")).pipe(
      Nr(0, qr),
      k(() => yn(e)),
      he(yn(e))
    );
  ...
  var jo = 20,
    ...
    qo = typeof MutationObserver != "undefined",
    Do = (function () {
      function e() {
        (this.connected_ = !1),
          ...
          (this.refresh = Uo(this.refresh.bind(this), jo));
      }
      return (
  ...
  function $o(e) {
    for (
      var r = ["top", "right", "bottom", "left"], t = {}, n = 0, o = r;
      n < o.length;
      n++
    ) {
      var i = o[n],
  ...
  function No(e) {
    var r = e.getBBox();
    return Tr(0, 0, r.width, r.height);
  }
  function Go(e) {
    var r = e.clientWidth,
      t = e.clientHeight;
    ...
    if (
      (n.boxSizing === "border-box" &&
        (Math.round(u + i) !== r && (u -= gn(n, "left", "right") + i),
        Math.round(s + a) !== t && (s -= gn(n, "top", "bottom") + a)),
      !Ko(e))
    ) {
      var f = Math.round(u + i) - r,
        c = Math.round(s + a) - t;
      Math.abs(f) !== 1 && (u -= f), Math.abs(c) !== 1 && (s -= c);
    }
    return Tr(o.left, o.top, u, s);
  }
  var Qo = (function () {
    return typeof SVGGraphicsElement != "undefined"
      ...
      : function (e) {
          return (
            e instanceof ke(e).SVGElement && typeof e.getBBox == "function"
          );
        };
  })();
  function Ko(e) {
  ...
  var Bo = (function () {
      function e(r) {
        (this.broadcastWidth = 0),
          ...
          (this.contentRect_ = Tr(0, 0, 0, 0)),
          (this.target = r);
      }
      return (
        (e.prototype.isActive = function () {
          var r = Yo(this.target);
          return (
            (this.contentRect_ = r),
    ...
    Xo = (function () {
      function e(r, t) {
        var n = Jo(t);
        _n(this, { target: r, contentRect: n });
      }
      return e;
    })(),
    Zo = (function () {
      ...
      return (
        (e.prototype.observe = function (r) {
          if (!arguments.length)
        ...
        (e.prototype.unobserve = function (r) {
          ...
          if (
            ...
            var t = this.observations_;
            !t.has(r) ||
              (t.delete(r), t.size || this.controller_.removeObserver(this));
          }
        }),
          ...
          if (!!this.hasActive()) {
            var r = this.callbackCtx_,
              t = this.activeObservations_.map(function (n) {
                return new Xo(n.target, n.broadcastRect());
              });
    ...
    En = typeof WeakMap != "undefined" ? new WeakMap() : new wn(),
    On = (function () {
      function e(r) {
  ...
  ["observe", "unobserve", "disconnect"].forEach(function (e) {
    On.prototype[e] = function () {
      var r;
      return (r = En.get(this))[e].apply(r, arguments);
    };
  });
  var ei = (function () {
      return typeof Er.ResizeObserver != "undefined" ? Er.ResizeObserver : On;
    })(),
    Tn = ei;
  var ri = new J(),
    Hp = Ve(() =>
      X(
        new Tn((e) => {
          for (let r of e) ri.next(r);
        })
      )
    ).pipe(
      N((e) => $(qe, X(e)).pipe(_e(() => e.disconnect()))),
      Se(1)
    );
  function An(e) {
  ...
  function Ln(e, r) {
    ...
    else if (Array.isArray(r)) for (let t of r) Ln(e, t);
  }
  function ee(e, r, ...t) {
  ...
  function ni(e, r = { credentials: "same-origin" }) {
    return B(fetch(`${e}`, r)).pipe(
      wr(() => le),
      N((t) => (t.status !== 200 ? $r(() => new Error(t.statusText)) : X(t)))
    );
  }
  function Ar(e, r) {
    return ni(e, r).pipe(
  ...
  function et(e, r = document) {
    return dn(`[data-mdx-component=${e}]`, r);
  }
  var oi = Z("#__config"),
    De = JSON.parse(oi.textContent);
  De.base = `${new URL(De.base, Cn())}`;
  function Pn() {
    return De;
  }
  function Fn(e, r) {
    return typeof r != "undefined"
      ? De.translations[e].replace("#", r.toString())
      : De.translations[e];
  }
  function kn(e) {
    let r = bn(e),
      t = $(Q(e, "keyup"), Q(e, "focus").pipe(Jr(1))).pipe(
        k(() => e.value),
        he(e.value),
        pe()
      );
    return (
      ...
      Re([t, r]).pipe(k(([n, o]) => ({ ref: e, value: n, focus: o })))
    );
  }
  var nt = kr(tt());
  var Nn = kr(tt());
  function $n(e, r) {
    return (0, Nn.wrap)(e.shortcode, r, {
  ...
  function Gn(e, r, t) {
    return ee(
      ...
      ee("span", { class: "twemoji" }, ee("img", { src: e.url })),
      ee(
        "button",
        {
          class: "md-clipboard--inline",
          title: Fn("clipboard.copy"),
          "data-clipboard-text": t ? e.shortcode : `:${e.shortcode}:`,
        },
        ee("code", null, t ? $n(e, r) : `:${$n(e, r)}:`)
      )
    );
  }
  function Qn(e) {
        ...
        return Re([
          ...
          N((n) =>
            r.pipe(
              k(({ icons: o, emojis: i }) => ({
                data: n.map((a) => {
                  let u = a in o.data ? o : i;
                  return { shortcode: a, url: [u.base, u.data[a]].join("") };
                }),
              }))
            )
          )
  ...
  function Yn(e, { index$: r, query$: t }) {
    let n = new J(),
      o = In(e).pipe(we(Boolean)),
      i = Z(":scope > :first-child", e);
    n.pipe(Fe(t)).subscribe(([{ data: s }, { value: f }]) => {
      if (f)
        switch (s.length) {
          case 0:
    ...
    return (
      n
        ...
        .subscribe(([s, { value: f }]) => u.appendChild(Gn(s, f, a))),
      ii(e, { query$: t, index$: r }).pipe(
        Pe((s) => n.next(s)),
        _e(() => n.complete()),
        k((s) => Qe({ ref: e }, s))
      )
  ...
  function Jn(e) {
    let r = Pn(),
      t = Ar(new URL("assets/javascripts/iconsearch_index.json", r.base)),
      n = He("iconsearch-query", e),
      o = He("iconsearch-result", e),
      i = kn(n),
      a = Yn(o, { index$: t, query$: i });
    return $(i, a);
  }
  function Bn(e) {
    let r = Ar("https://3if8u9o552.execute-api.us-east-1.amazonaws.com/_/"),
    ...
    return (
      r.subscribe((o) => {
        ...
        for (let a of o.sponsors)
          a.type === "public" && i.appendChild(Qn(a.user));
        i.appendChild(
          Kn(o.sponsors.filter(({ type: a }) => a === "private").length)
        ),
      ...
      r.pipe(k((o) => Qe({ ref: e }, o)))
    );
  }
  function Xn() {
    let { origin: e } = new URL(location.href);
    Q(document.body, "click").subscribe((r) => {
  ...
  Xn();
  var ai = document$.pipe(
    N(() =>
      $(
        ...et("iconsearch").map((e) => Jn(e)),
        ...et("sponsorship").map((e) => Bn(e))
      )
    )
  );
  ai.subscribe();
})();
//# sourceMappingURL=custom.525be7f2.min.js.map
