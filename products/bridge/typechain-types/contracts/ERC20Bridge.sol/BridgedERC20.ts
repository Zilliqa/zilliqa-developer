...
export interface BridgedERC20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface BridgedERC20 extends BaseContract {
  connect(runner?: ContractRunner | null): BridgedERC20;
  waitForDeployment(): Promise<this>;

  interface: BridgedERC20Interface;
