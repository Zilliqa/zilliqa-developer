...
/**
 * Added PausableUpgreadeable in the middle of the inheritance list. Along with relevant test functions
 */
abstract contract TokenManagerUpgradeableTestV5 is
    ITokenManager,
    Initializable,
    PausableUpgradeable,
    UUPSUpgradeable,
    OwnableUpgradeable
{
    ...
    function pausableFunction() public view whenNotPaused returns (bool) {
        return true;
    }
...
contract TokenManagerTestV5 is TokenManagerUpgradeableTestV5 {
