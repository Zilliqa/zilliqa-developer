...
contract ZRC2ProxyForZRC2 is IERC20 {
    ...
    constructor(address zrc2_address) {
        ...
        symbol = zrc2_proxy.read_string("symbol");
        decimals = uint256(zrc2_proxy.read_uint32("decimals")).toUint8();
        name = zrc2_proxy.read_string("name");
    }
    ...
    function totalSupply() external view returns (uint256) {
        return zrc2_proxy.read_uint128("total_supply");
    }
    ...
    function balanceOf(address tokenOwner) external view returns (uint256) {
        return zrc2_proxy.read_map_uint128("balances", tokenOwner);
    }
    ...
    function allowance(
        ...
        return
            zrc2_proxy.read_nested_map_uint128(
                "allowances",
                tokenOwner,
                spender
            );
