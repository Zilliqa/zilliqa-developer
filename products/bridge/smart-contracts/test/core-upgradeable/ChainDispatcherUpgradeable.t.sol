...
import {ChainDispatcherUpgradeable, IChainDispatcherEvents, IChainDispatcherErrors} from "contracts/core-upgradeable/ChainDispatcherUpgradeable.sol";

import {ISignatureValidatorErrors} from "contracts/core/SignatureValidator.sol";
import {IDispatchReplayCheckerErrors} from "contracts/core-upgradeable/DispatchReplayCheckerUpgradeable.sol";
...
contract ChainDispatcherUpgradeableTests is DispatcherFixture {
    using DispatchArgsBuilder for DispatchArgsBuilder.DispatchArgs;
