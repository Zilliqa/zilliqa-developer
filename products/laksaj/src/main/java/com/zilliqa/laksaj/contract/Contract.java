...
import com.zilliqa.laksaj.transaction.TxStatus;
...
public class Contract {
    ...
    private Value[] init;
    private String abi;
    private List<com.zilliqa.laksaj.blockchain.Contract.State> state;
    ...
    public Contract(ContractFactory factory, String code, String abi, String address, Value[] init, List<com.zilliqa.laksaj.blockchain.Contract.State> state) throws Exception {
