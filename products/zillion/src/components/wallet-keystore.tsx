...
function WalletKeystore(props: any) {
  ...
  const unlockWallet = () => {
    ...
    reader.onload = async () => {
      ...
      const address = await ZilSigner.addWalletByKeystore(
        keystoreJSON,
        passphrase
      ); // base16 with 0x
      ...
      if (address !== OperationStatus.ERROR) {
        ...
        Alert(
          "error",
          "Keystore Decrypt Error",
          "Please ensure your passphrase is correct."
        );
      }
    };
    ...
    <div className="wallet-access">
      ...
      <div>
        <div id="keystore">
          ...
          <label htmlFor="browsekeystore">
            {filename ? "Select wallet file" : "Select wallet file"}
          </label>
