  ...
  return (
    <div>
      ...
      <div className="d-flex mb-4">
        <div>
          <span className="fee-head">
            <strong>Fee</strong>:{" "}
            <span className="fee">
              {computeGasFees().shiftedBy(-12).toFixed()}
            </span>{" "}
            ZIL
          </span>
        </div>
        ...
        >
          {gasOption ? (
            <div className="advanced-btn-div">
              <IconArrowDropupLine width="28" height="28" className="pb-1" />
              <span>Advanced Settings</span>
            </div>
          ) : (
            <div className="advanced-btn-div">
              <IconArrowDropdownLine width="28" height="28" className="pb-1" />
              <span>Advanced Settings</span>
            </div>
          )}
        </button>
