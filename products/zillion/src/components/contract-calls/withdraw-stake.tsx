...
function WithdrawStakeModal(props: any) {
  ...
  const hasRewardToWithdraw = async () => {
    ...
    if (delegRewards.gt(new BN(0))) {
      ...
      Alert(
        ...
        "Please withdraw the rewards before withdrawing the staked amount."
      );
      return true;
    }
  ...
  const withdrawStake = async () => {
    ...
    if (!ssnAddress) {
      Alert(
        "error",
        "Invalid Node",
        "node address should be bech32 or checksum format."
      );
      return null;
    }
    ...
    if (!withdrawAmt) {
      ...
      try {
        ...
        Alert(
          "error",
          "Invalid Withdraw Amount",
          "Please check your withdraw amount again."
        );
        return null;
      }
    }
    ...
    if (new BN(withdrawAmtQa).gt(new BN(delegAmtQa))) {
      Alert(
        "info",
        "Invalid Withdraw Amount",
        "You only have " + convertQaToCommaStr(delegAmtQa) + " ZIL to withdraw."
      );
      setIsPending("");
      return null;
      ...
      Alert(
        ...
        "Please leave at least " +
          ...
          " ZIL (min. stake amount) or withdraw ALL."
      );
      setIsPending("");
      return null;
    }
  ...
  return (
    <div
      id="withdraw-stake-modal"
      className="modal fade"
      tabIndex={-1}
      role="dialog"
      aria-labelledby="withdrawStakeModalLabel"
      aria-hidden="true"
    >
      <div
          ...
          {isPending ? (
            ...
            <>
              <div className="modal-header">
                <h5 className="modal-title" id="withdrawStakeModalLabel">
              ...
              <div className="modal-body">
                ...
                <div className="d-flex">
                  <button
                    type="button"
                    className="btn btn-user-action mx-auto mt-2 shadow-none"
