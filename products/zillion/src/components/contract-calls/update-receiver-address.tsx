...
function UpdateReceiverAddress(props: any) {
  ...
  const receiver = useAppSelector(
    (state) => state.user.operator_stats.receiver
  );
  ...
  const updateAddress = async () => {
    if (!newAddress) {
      Alert(
        "error",
        "Invalid Address",
        "Receiving address should be bech32 or checksum format."
      );
      return null;
    }
  ...
  return (
    <div
      id="update-recv-addr-modal"
      className="modal fade"
      tabIndex={-1}
      role="dialog"
      aria-labelledby="updateRecvAddrModalLabel"
      aria-hidden="true"
    >
      <div
            ...
            <>
              ...
              <div className="modal-body">
                ...
                <input
                  ...
                  placeholder="Enter new address in bech32 format"
                />
                <GasSettings
                  gasOption={gasOption}
                  gasPrice={gasPrice}
