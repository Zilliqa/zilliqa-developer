...
function WithdrawRewardModal(props: any) {
  ...
  return (
    <div
      id="withdraw-reward-modal"
      className="modal fade"
      tabIndex={-1}
      role="dialog"
      aria-labelledby="withdrawRewardModalLabel"
      aria-hidden="true"
    >
      <div
              ...
              <div className="modal-body">
                <div className="row node-details-wrapper mb-4">
                  ...
                  <div className="col node-details-panel">
                    ...
                    <span>
                      {new BigNumber(
                        stakeModalData.rewards
                      ).isGreaterThanOrEqualTo(10 ** 9)
                        ? convertQaToCommaStr(stakeModalData.rewards)
                        : convertQaToZilFull(stakeModalData.rewards)}{" "}
                      ZIL
                    </span>
                  </div>
                </div>
