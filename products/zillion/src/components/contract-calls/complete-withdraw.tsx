...
function CompleteWithdrawModal(props: any) {
  ...
  return (
    <div
      ...
      tabIndex={-1}
      role="dialog"
      aria-labelledby="completeWithdrawModalLabel"
      aria-hidden="true"
    >
      <div
          ...
          {isPending ? (
            ...
            <>
              <div className="modal-header">
                <h5 className="modal-title" id="completeWithdrawModalLabel">
              ...
              <div className="modal-body">
                <p className="mb-4">
                  Are you sure you wish to withdraw all your pending stakes?
                </p>
                <GasSettings
                  gasOption={gasOption}
                  gasPrice={gasPrice}
                ...
                <div className="d-flex">
                  <button
                    type="button"
                    className="btn btn-user-action mx-auto"
