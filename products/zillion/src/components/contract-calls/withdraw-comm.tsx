...
function WithdrawCommModal(props: any) {
  ...
  const commRewards = useAppSelector(
    (state) => state.user.operator_stats.commReward
  );
  ...
  return (
    <div
      id="withdraw-comm-modal"
      className="modal fade"
      tabIndex={-1}
      role="dialog"
      aria-labelledby="withdrawCommModalLabel"
      aria-hidden="true"
    >
      <div
          ...
          {isPending ? (
            ...
            <>
              <div className="modal-header">
                <h5 className="modal-title" id="withdrawCommModalLabel">
                  Withdraw Commission
                </h5>
                <button
                  type="button"
              ...
              <div className="modal-body">
                <div className="row node-details-wrapper mb-4">
                  <div className="col node-details-panel">
                    ...
                    <span>
                      {commRewards ? convertQaToCommaStr(commRewards) : "0.000"}{" "}
                      ZIL
                    </span>
                  </div>
                </div>
                <p>
                  Are you sure you wish to withdraw{" "}
                  <strong>
                    {commRewards ? convertQaToCommaStr(commRewards) : "0.000"}
                  </strong>{" "}
                  ZIL?
