    ...
    try {
      ...
      if (!connected) {
        Alert(
          "error",
          "Locked Wallet",
          "Please allow ZilPay to access this app."
        );
        return null;
      }
      ...
      Alert(
        "error",
        "Unable to access ZilPay",
        "Please check if there is a new ZilPay version or clear your browser cache."
      );
    }
  };
    ...
    <>
      <div className="wallet-access">
        ...
        {env === Environment.PROD ? (
          <p className="my-4">
            <strong>Note:</strong> We remind all users to set your ZilPay
            network to <strong>Mainnet</strong>
          </p>
        ) : (
          <p className="my-4">
            <strong>Note:</strong> We remind all users to set your ZilPay
            network to <strong>Testnet</strong>
          </p>
        )}
