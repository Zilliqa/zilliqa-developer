...
function Home(props: any) {
  ...
  const redirectToDashboard = async (
    ...
    dispatch(
      INIT_USER({
        address_base16: addressBase16,
        address_bech32: addressBech32,
          ...
          <div className="cover-content col-12 text-center">
            ...
            <div className="d-sm-flex justify-content-center pt-5">
              <div
                ...
                onClick={() =>
                  (window.location.href = "https://dapp.avely.fi/")
                }
              >
              ...
              <div
                ...
                onClick={() =>
                  (window.location.href =
                    "https://instantunstaking.ignitedao.io/")
                }
              >
                <img
                  className="mr-1 cover-img"
                  src={IgniteLogo}
                  width={26}
                  height={26}
                ></img>
            ...
            <div className="d-flex justify-content-center h-100 py-3">
              <div className="explorer-search">
                <input
                  ...
                  onKeyDown={handleExplorerKeyPress}
            ...
            {!isShowAccessMethod ? (
              <div className="initial-load">
                ...
                <div
                  ...
                  onClick={() =>
                    handleShowAccessMethod(Role.DELEGATOR.toString())
                  }
                >
                  Sign in for Delegators
                </div>
                <div
                  className="btn btn-sign-in mt-4 mx-3"
                  style={{ width: "250px", textAlign: "center" }}
                  onClick={() =>
                    handleShowAccessMethod(Role.OPERATOR.toString())
                  }
                >
              ...
              <>
                ...
                <p className="wallet-connect-text animate__animated animate__fadeIn">
                  <strong>Connect your wallet to start</strong>
                </p>
                <div
                  id="wallet-access"
                  className="row align-items-center justify-content-center animate__animated animate__fadeIn mb-4"
                >
                  <div
                  ...
                  >
                    <IconKeystoreLine
                      className="home-icon my-4"
                      height="42px"
                    />
                    <span className="d-block mt-0.5">Keystore</span>
                  </div>
                  ...
                  >
                    <IconLedgerLine className="home-icon icon-ledger-line my-4" />
                    <span className="d-block mt-0.5">Ledger</span>
                  </div>
                  ...
                  <div
                    ...
                    data-tip={
                      env === Environment.PROD
                        ? "Ensure your ZilPay is on Mainnet network"
                        : "Ensure your ZilPay is on Testnet network"
                    }
                  >
                    <IconZilPayLine className="home-icon icon-zilpay-line my-4" />
                    <span className="d-block mt-0.5">ZilPay</span>
                  </div>
                ...
                <button
                  type="button"
                  className="btn btn-user-action-cancel mt-5 animate__animated animate__fadeIn"
                  onClick={() => resetView()}
                >
                  Back to Main
                </button>
