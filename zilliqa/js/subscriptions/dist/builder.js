...
exports.SubscriptionBuilder = void 0;
var newblock_1 = require("./newblock");
var newevent_1 = require("./newevent");
var SubscriptionBuilder = /** @class */ (function () {
    ...
    SubscriptionBuilder.prototype.buildNewBlockSubscriptions = function (url, options) {
        return new newblock_1.NewTxBlockSubscription(url, options);
    };
    SubscriptionBuilder.prototype.buildEventLogSubscriptions = function (url, options) {
        return new newevent_1.NewEventSubscription(url, options);
    };
